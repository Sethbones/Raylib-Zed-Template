...
*   Seth's Zed Template
*
*   This template is a collection of scripts intended to more easily kickstart a project without having to deal with any make scripts
*
*   Linux only for now and will likely stay that way for a good while
*
********************************************************************************************/
